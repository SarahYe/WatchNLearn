          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li  class="active"><a href="intermediate.php"> Intermediate </a></li>
    ...
    <div class="row centered mt mb">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-4 gallery">
          <div class="thumbnail">
            <img src="assets/img/portfolio/serie.jpeg" alt="kids" style="width:100%">
            <div class="caption">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 gallery">
          <div class="thumbnail">
                <img src="assets/img/portfolio/lesson.jpg" class="img-rounded" alt="conversation" style="width:100%">
                <div class="caption">
                  <p> Lorem ipsum donecid elt non mi orta gravida at eget metus</p>
                </div>
              </div>
