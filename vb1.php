	...
	<div class="container">
        ...
        <div class="col-lg-3">
         <form method="post" action='vb1.php'>
          ...
          <input type="submit" value="Check your answers" href="vb1.php#results"/>
         </form>
        </div>
      </div> <!--/fin row-->
...
?>
    ...
    <ul class="pager">
        ...
        <li class="next"><a href="vb22.php">Next</a></li>
    </ul>
    </div>
  </div>
